...
public class P1testActivity extends AppCompatActivity {
    ...
    private void advance() {
        Intent intent = new Intent(P1testActivity.this, Main2Activity.class);
        startActivity(intent);
    }
    private void gameOver() {
        Intent intent = new Intent(P1testActivity.this, MainActivity.class);
        startActivity(intent);
    }
